      ...
      sql`
          ...
          created_draft AS (
            ...
            SELECT
              ...
              'draft'::quote_status,
              locked_target.pricing_mode,
              locked_target.pricing_version_id,
              locked_target.base_subtotal,
              locked_target.pre_discount_subtotal,
              locked_target.discount_total,
